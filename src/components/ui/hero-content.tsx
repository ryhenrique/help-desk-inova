    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
      <div className="text-center mb-16 sm:mb-20 lg:mb-24 max-w-6xl mx-auto">
        <motion.div 
          ...
          className="mb-8"
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-center tracking-tight mb-6 text-white">
          ...
          <p className="text-lg sm:text-xl md:text-2xl leading-relaxed max-w-5xl mx-auto font-light text-white/90">
            17 anos transformando empresas com infraestrutura de TI robusta, 
            <span className="font-semibold text-white"> suporte especializado </span>
        ...
        >
          ...
          <Button 
            size="lg" 
            className="btn-secondary-white px-8 py-4 font-semibold rounded-xl transition-all duration-300 text-lg border-2 border-white/30 hover:border-white/50"
            onClick={() => {
